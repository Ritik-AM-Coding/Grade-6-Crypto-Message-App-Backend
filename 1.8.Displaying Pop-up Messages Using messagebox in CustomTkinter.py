...
# On line 33 get the message from the text box (starting from line 1, char 0 to the end)
# On line 42 show a warning if no image is selected or message is missing

#Task 1: Uncomment line 37 & write the code to hide the message in the image using:lsb.hide(file_path,data)
