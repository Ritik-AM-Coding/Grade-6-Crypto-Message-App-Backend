...
#On line no 21 it opens an image file that the user selects from their computer.
...
#Task 2:Change the max size of the image on line 22 to 240 as height and width. 
