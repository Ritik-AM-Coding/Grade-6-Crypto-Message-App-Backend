#Task 1:Uncomment line 64, Use lsb.reveal(filepath) to extract the hidden message from the image
#Task 2:Uncomment line 65 & Clear any previous text in the message entry box using Data_entry.delete(1.0, "end")
#Task 3:Uncomment line 66-68 & If a message was found, insert it in the text box and show success message
#Task 4:Uncomment line 71 & If something goes wrong, show an error message saying no message was found
#Task 5:Uncomment line 74, Show a warning message if no image file is selected
